...
def validate_password():
    ...
    if not username_error and not password_error and not verify_error and not email_error:
        ...
        return render_template('index.html',title="Signup", username = username, email = email, username_error = username_error, password_error = password_error, verify_error = verify_error, email_error = email_error)
